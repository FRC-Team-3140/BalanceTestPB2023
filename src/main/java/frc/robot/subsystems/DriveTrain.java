...
public class DriveTrain extends SubsystemBase {
    ...
    */
    public DriveTrain() {
        ...
        leftMotorGroup = new MotorControllerGroup(spark1, talonSRX4, talonSRX6);
        addChild("Left Motor Group", leftMotorGroup);

        //talonSRX4 = new WPI_TalonSRX(3);
        spark2 = new CANSparkMax(8, MotorType.kBrushless);

        talonSRX5 = new WPI_TalonSRX(5);

        talonSRX7 = new WPI_TalonSRX(7);

        rightMotorGroup = new MotorControllerGroup(spark2, talonSRX5, talonSRX7);
        ...
        talonSRX7.set(ControlMode.PercentOutput, 0.0);
        talonSRX7.configOpenloopRamp(0.2);
        talonSRX7.setInverted(true);
        ...
        talonSRX7.configSupplyCurrentLimit(current_limit);
