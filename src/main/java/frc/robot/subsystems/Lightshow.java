    ...
    */
    ...
    private void rotateColors(Color[] colors, int width, double speed) {
        ...
        for (int i = 0; i < light_count; i++) {
            // Compute the starting position of the colors.  This is defined based on 
            // the speed and the timestamp.
            double pos = speed * timestamp + 1.0 * i;

            // The width of the colors is added to the position to determine which color is 
            // assigned to led i.  The modulus is used to wrap the colors around the strip.
            int color_index = (int) (pos + width) % N;
