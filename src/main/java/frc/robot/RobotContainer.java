...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        rBButton.whileTrue(new LightUSA2(m_lightshow).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

        final JoystickButton lBButton = new JoystickButton(driverController, XboxController.Button.kLeftBumper.value);
        lBButton.whileTrue(new LightAdmirals(m_lightshow).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
        ...
        aButton.whileTrue(new FlagWave(m_flagwaver).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
